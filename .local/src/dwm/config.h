...
static const Key keys[] = {
	...
	{ MODKEY|ControlMask,		XK_space,	spawn,		{.v = (const char*[]){ "cycle-keyboard", NULL } } },
	...
	{ 0, XF86XK_MonBrightnessUp,	spawn,		{.v = (const char*[]){ "light", "-inc", "10", NULL } } },
	{ 0, XF86XK_MonBrightnessDown,	spawn,		{.v = (const char*[]){ "light", "-dec", "10", NULL } } },
